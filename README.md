...
```text
21764A2B5FCFF580ADF0C5790F13D272906C0B1D0BA4ACE17DAFBF23F3BC286A
```
...
程序首次启动时默认保留 BIOS 风扇控制。正常退出会尝试归还 BIOS 控制权；遇到异常状态时，请关闭程序、重启电脑，并确认 BIOS 风扇策略恢复正常后再继续排查。自启仅写入当前用户或任务计划，不再依赖中文系统命令输出判断结果。
